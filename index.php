...
?>
 ...
 <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 px-0" style="margin-bottom: 90px;">
        <div class="row mx-0 align-items-center">
            <div class="col-lg-6 px-md-5 text-center text-lg-left">
                <h1 class="display-2 text-uppercase mb-3">Best Digital Agency</h1>
                <p class="text-dark mb-4">We are an advertising agency designed to solve your design problems and others. In order to expand your brand and business on a professional level.</p>
                <a href="" class="btn btn-dark text-uppercase mt-1 py-3 px-5">Learn More About Us </a>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h5 class="text-uppercase text-primary mb-3">
                        We are aware that the technological era is the one that will reign in these coming years, that is why we are prepared for it.
                    </h5>
                    <p class="mb-4">Our agency has had an enormous trajectory over the years, which has helped us to continue increasing the possibilities of meeting expectations in terms of design, advertising and other matters related to multimedia that are currently found.</p>
            ...
            <div class="row">
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-5 mb-4">
                        ...
                        <p class="m-0">To help you to have differents ways to increase you bussiness.</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-5 mb-4">
                        ...
                        <p class="m-0">To make your websites and portals more professional.</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-5 mb-4">
                        ...
                        <p class="m-0">To help you promote all bussiness you need to increase.</p>
                    </div>
                </div>
                <div class="col-lg-3 mb-2">
                    <div class="service-item rounded p-5 mb-4">
                        ...
                        <p class="m-0">To analize and copywrite any special advertising forms.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Take A Look To Our Projects</h1>
            <div class="row">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Check Out Our Bussiness Plans</h1>
            <div class="row">
                <div class="col-lg-4 mb-2">
                    <div class="bg-light rounded text-center pt-5 mt-lg-5 mb-4">
                        <h2 class="text-uppercase">Basic</h2>
                        <h6 class="text-uppercase text-body mb-5">For Beginners</h6>
                        ...
                        <div class="text-center py-4">
                            ...
                            <p>Graphic Design</p>
                            <p>Marketing</p>
                            <a href="" class="btn btn-dark text-uppercase py-2 px-4 my-3">Pay Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                    <div class="bg-dark rounded text-center pt-5 mb-4">
                        ...
                        <h6 class="text-uppercase text-secondary mb-5">For Intermediate</h6>
                        ...
                        <div class="text-center text-secondary py-4">
                            <p>HTML5 </p>
                            <p>Bootstrap and Web Desing</p>
                            <p>Advertising</p>
                            <p>Marketing</p>
                            <a href="" class="btn btn-primary text-uppercase py-2 px-4 my-3">Pay Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                    <div class="bg-light rounded text-center pt-5 mt-lg-5 mb-4">
                        ...
                        <h6 class="text-uppercase text-body mb-5">For Advance</h6>
                        <div class="text-center bg-dark rounded-circle p-4 mb-2">
                            <h1 class="display-4 text-white mb-0">
                                <small class="align-top"
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item position-relative text-center rounded p-4">
                    ...
                    <h5 class="text-uppercase">Oscar Soto</h5>
                    <p class="text-uppercase">Cybersecurity Professional</p>
                    <p class="text-secondary">That advertising team, helped me a lot to increase the public of my personal brand project for a cybersecurity enterprise. Im really gratefull for it!</p>
                </div>
                <div class="testimonial-item position-relative text-center rounded p-4">
                    <img class="img-fluid rounded mx-auto my-4" src="img/testimonial-2.jpg" alt="">
                    <h5 class="text-uppercase">Sam Ortiz</h5>
                    <p class="text-uppercase">Call Center CEO</p>
                    <p class="text-secondary">Haik Media helped me to reach out a lot of new colleges to work on my personal project of a call center enterprise.</p>
                </div>
                <div class="testimonial-item position-relative text-center rounded p-4">
                    <img class="img-fluid rounded mx-auto my-4" src="img/testimonial-3.jpg" alt="">
                    <h5 class="text-uppercase">Sonia Slard</h5>
                    <p class="text-uppercase">Bank CEO</p>
                    <p class="text-secondary">The complete and professionl list of services that this team have its incredible. I would recommend this agency to all my bussiness colleges.</p>
                </div>
                <div class="testimonial-item position-relative text-center rounded p-4">
                    <img class="img-fluid rounded mx-auto my-4" src="img/testimonial-4.jpg" alt="">
                    <h5 class="text-uppercase">Neyl Astrid</h5>
                    <p class="text-uppercase">Design Master</p>
                    <p class="text-secondary">The Haik Media Agency, gived me the oportunity to grow as a professional on my personal brand, with adquiring a bussiness plan to increase my enterprise.</p>
                </div>
            </div>
        </div>
    </div>
