...
<div class="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 mt-n2 text-white display-4">HAIK MEDIA</h1>
                </a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p>Follow up our Advertising and Marketing Agency to become your works more professional that they are. Tust us!</p>
                ...
                <p><i class="fa fa-envelope text-white mr-2"></i>info@haikmedia.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="mb-4">Subscribe to our email list to have our bussiness plans with more details.</p>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="mb-2 text-center text-white-50">&copy; <a href="#">HAIK MEDIA AGENCY</a>. All Rights Reserved.</p>
